...
var file_proto_service_service_proto_rawDesc = []byte{
	...
	0x32, 0xab, 0x06, 0x0a, 0x02, 0x6d, 0x65, 0x12, 0x84, 0x01, 0x0a, 0x0d, 0x46, 0x69, 0x6e, 0x64,
	...
	0x12, 0x77, 0x0a, 0x0a, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x25,
	0x2e, 0x76, 0x32, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	...
	,
...
var file_proto_service_service_proto_goTypes = []interface{}{
	...
	(*message.FetchPostsRequest)(nil),            // 5: v2.service.message.FetchPostsRequest
	(*message.FindAdminUUIDResponse)(nil),        // 6: v2.service.message.FindAdminUUIDResponse
	(*message.InsertAdminUUIDResponse)(nil),      // 7: v2.service.message.InsertAdminUUIDResponse
	(*message.LoginAdminResponse)(nil),           // 8: v2.service.message.LoginAdminResponse
	(*message.FetchDistrictWeatherResponse)(nil), // 9: v2.service.message.FetchDistrictWeatherResponse
	(*message.UploadPostResponse)(nil),           // 10: v2.service.message.UploadPostResponse
	(*message.FetchPostsResponse)(nil),           // 11: v2.service.message.FetchPostsResponse
}
var file_proto_service_service_proto_depIdxs = []int32{
	...
	5,  // 5: v2.service.me.FetchPosts:input_type -> v2.service.message.FetchPostsRequest
	6,  // 6: v2.service.me.FindAdminUUID:output_type -> v2.service.message.FindAdminUUIDResponse
	7,  // 7: v2.service.me.InsertAdminUUID:output_type -> v2.service.message.InsertAdminUUIDResponse
	8,  // 8: v2.service.me.LoginAdmin:output_type -> v2.service.message.LoginAdminResponse
	9,  // 9: v2.service.me.FetchDistrictWeather:output_type -> v2.service.message.FetchDistrictWeatherResponse
	10, // 10: v2.service.me.UploadPost:output_type -> v2.service.message.UploadPostResponse
	11, // 11: v2.service.me.FetchPosts:output_type -> v2.service.message.FetchPostsResponse
