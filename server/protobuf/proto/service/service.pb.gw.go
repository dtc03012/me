...
func request_Me_CheckAdmin_0(ctx context.Context, marshaler runtime.Marshaler, client MeClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq message.CheckAdminRequest
...
// RegisterMeHandlerServer registers the http handlers for handler Me to "mux".
...
func RegisterMeHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MeServer) error {
	...
	mux.Handle("POST", pattern_Me_CheckAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v2.handler.Me/CheckAdmin", runtime.WithHTTPPathPattern("/v2/check-admin"))
		if err != nil {
	...
	mux.Handle("GET", pattern_Me_CheckDistrictWeather_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v2.handler.Me/CheckDistrictWeather", runtime.WithHTTPPathPattern("/v2/check-district-weather/{district}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
// RegisterMeHandler registers the http handlers for handler Me to "mux".
...
// RegisterMeHandlerClient registers the http handlers for handler Me
...
func RegisterMeHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MeClient) error {
	...
	mux.Handle("POST", pattern_Me_CheckAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/v2.handler.Me/CheckAdmin", runtime.WithHTTPPathPattern("/v2/check-admin"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Me_CheckDistrictWeather_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/v2.handler.Me/CheckDistrictWeather", runtime.WithHTTPPathPattern("/v2/check-district-weather/{district}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Me_CheckAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v2", "check-admin"}, ""))
